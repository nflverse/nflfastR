...
#' \item{fantasy_id}{ID of the rusher on rush players or receiver on pass players.}
#' \item{name}{Name of the 'passer' if it is not 'NA', or name of the 'rusher' otherwise.}
#' \item{fantasy}{Name of the rusher on rush players or receiver on pass plays.}
#' \item{fantasy_id}{ID of the rusher on rush players or receiver on pass plays.}
#' \item{fantasy_player_name}{Name of the rusher on rush players or receiver on pass plays (from official stats).}
#' \item{fantasy_player_id}{ID of the rusher on rush players or receiver on pass plays (from official stats).}
