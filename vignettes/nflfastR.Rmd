...
ids <- fast_scraper_schedules(2017:2019) %>% filter(game_type == "SB") %>% pull(game_id)
...
These match the official stats on NFL.com with the exception of Watson missing 22 passing yards (maybe a bug related to laterals?).
