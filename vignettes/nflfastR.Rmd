...
What if we want total yards from scrimmage? We'll demonstrate two methods here. The harder way is to use the `fantasy_player_name` column, which is the rusher on rush plays and receiver on receiving plays:
