...
* Added the variables `racr` ("Receiver Air Conversion Ratio"), `target_share`, `air_yards_share` and `wopr` ("Weighted Opportunity Rating") to the output of `calculate_player_stats()`
