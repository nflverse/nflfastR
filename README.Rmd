...
``` {r wp, warning = FALSE, message = FALSE}
...
Because the Patriots were favored by 20.5 points in this Week 3 Jets-Patriots game, the naive (no-spread) and spread win probabilities differ dramatically. In the no-spread model, `home_wp` begins at 0.56 (greater than 0.50 because home team advantage is included in the model) and `vegas_home_wp` is 0.858. We have also included `vegas_wp` which is the win probability of the possession team, incorporating the spread.
