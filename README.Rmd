...
[![R build status](https://github.com/nflverse/nflfastR/workflows/R-CMD-check/badge.svg)](https://github.com/nflverse/nflfastR/actions)
...
* Hosts [a repository of play-by-play data going back to 1999](https://github.com/nflverse/nflfastR-data) for very quick access
...
To get a bug fix or to use a feature from the development version, you can install the development version of nflfastR from [GitHub](https://github.com/nflverse/nflfastR/) with:
...
df <- map_df(2014:2019, ~{
  readRDS(url(glue::glue('https://raw.githubusercontent.com/nflverse/nflfastR-data/master/data/play_by_play_{.x}.rds'))) %>%
...
```{r echo=FALSE, fig.align='center', fig.cap='', out.width='100%'}
knitr::include_graphics('https://github.com/nflverse/nflfastR/raw/master/man/figures/readme-cp-model-1.png')
```
